<template>
  ...
  <div>
    <v-list-item-subtitle class="text-wrap line-h20"
      ...
      <span class="grey--text text--darken-4 font-weight-bold">border</span>
      prop. If a
      <span class="grey--text text--darken-4 font-weight-bold">type</span> is
      set, it will use the types default color. If no
      <span class="grey--text text--darken-4 font-weight-bold">color</span> or
      <span class="grey--text text--darken-4 font-weight-bold">type</span> is
      set, the color will default to the inverted color of the applied theme
      (black for light and white/gray for dark).</v-list-item-subtitle
    >
    <div class="mt-4">
      ...
      <v-alert border="top" colored-border type="info" elevation="2"
        ...
        vitae, posuere imperdiet, leo. Morbi nec metus.</v-alert
      >
      <v-alert border="bottom" colored-border type="warning" elevation="2"
        ...
        non, auctor et, hendrerit quis, nisi. Phasellus leo dolor, tempus non,
        auctor et, hendrerit quis, nisi. Sed consequat, leo eget bibendum
        sodales, augue velit cursus nunc, quis gravida magna mi a libero. Donec
        elit libero, sodales nec, volutpat a, suscipit non, turpis.</v-alert
      >
